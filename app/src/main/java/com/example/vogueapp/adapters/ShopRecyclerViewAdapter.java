...
import com.example.vogueapp.ProductActivity;
...
//recycler viwe for the products in the viewing of the products
    @Override
    public ShopRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //creates the view holder for holding the data
